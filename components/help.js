...
const case_2 = () => render_desc("Maybe you are not connected to internet or your connection maybe poor, so try reconnecting to the internet.")
const case_3 = () => render_desc("Sometimes restarting the app might fix your error");
const case_4 = () => render_desc("Cache might give you some error, so you can try clearing cache from settings");
const case_5 = () => render_desc("You might need to reinstall your app by uninstalling and then installing it again");
const case_6 = () => render_desc("you can also try wiping your app's data completely from settings");
const case_7 = () => render_desc("If none of the cases from above helped you, then you might contact us from our email");
                ...
                <View style={{alignSelf:"stretch"}}>
                    <List.Section>
                        ...
                        <List.Accordion title="Case 2">
                            <List.Item title="Network Connection" description={case_2} />
                        </List.Accordion>
                        <List.Accordion title="Case 3">
                            <List.Item title="Restart" description={case_3} />
                        </List.Accordion>
                        <List.Accordion title="Case 4">
                            <List.Item title="Cache Delete" description={case_4} />
                        </List.Accordion>
                        <List.Accordion title="Case 5">
                            <List.Item title="Reinstalling" description={case_5} />
                        </List.Accordion>
                        <List.Accordion title="Case 6">
                            <List.Item title="Data Delete" description={case_6} />
                        </List.Accordion>
                        <List.Accordion title="Case 7">
                            <List.Item title="Contact us" description={case_7} />
                        </List.Accordion>
                    </List.Section>
                </View>
            </ScrollView>

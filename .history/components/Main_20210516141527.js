...
const askperm = () => {
    try {var granted = PermissionsAndroid.requestMultiple(
          [
...
function App({navigation, navigator}) {
    ...
    const permreq = async () => {
    var grant = await PermissionsAndroid.check(PermissionsAndroid.PERMISSIONS.WRITE_EXTERNAL_STORAGE)
    ...
    <View style={styles.scrollView}>
      <ScrollView contentContainerStyle={styles.scroller}>
        <View style={styles.container}>
            ...
            <Button mode="contained" style={styles.dwnld} onPress={permreq}>
                Download
            </Button>
        </View>
      </ScrollView>

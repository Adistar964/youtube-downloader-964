...
export default function Webb({navigation}){
    ...
    const goBack = () => {
    //     if(urlLoad != "https://m.youtube.com/"){
    //         if(route === "web"){
    //             webref.current.goBack();navigation.goBack(null);
    //         }else{
    //             navigation.goBack();
    //         }
    //     }
    //     else{navigation.navigate("land")}
    //     return true;
    ...
    useEffect(() =>{
        ...
        // return () => bk.removeEventListener("hardwareBackPress",goBack)
    // }, [])

...
function App({navigation, navigator}) {
  ...
  <View style={styles.container}>
      ...
      <View style={{justifyContent:"center", backgroundColor:"#32a852"}}>
        <TouchableOpacity style={{width:"50%", backgroundColor:"red", height:37}} onPress={permreq}>
            <Text style={styles.dwnld2}>Download</Text>
        </TouchableOpacity>
        </View>
  </View>
);

...
const video_icon = (props) => <Entypo name="video" size={24} {...props} />
    ...
    const show_files = (v,i) => {
        if (v !== undefined && typeof v === "string"){
            ...
            if (ext === ".mp4"){
                ...
                icon = () => renderIc("music-box", props);
            }
            return (
                <List.Item title={file_name} left={icon} right={() => renderIc("share-variant", props)} />
            )
        }
    }

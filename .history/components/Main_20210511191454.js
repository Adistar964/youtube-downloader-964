...
function App({navigation, navigator}) {
  ...
  <View style={styles.container}>
      ...
      <Button mode="contained" contentStyle={{color:"white"}} style={{marginTop:40 ,width:"50%", backgroundColor:"red", height:50, justifyContent:"center", alignItems:"center"}} onPress={permreq}>
          Download
      </Button>
  </View>
);

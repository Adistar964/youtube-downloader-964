        ...
        const render_right = props => {
            return (
                    <View style={styles.row}>
                        <Fw5icon name="play" onPress={()=>open_func(type,v,nav)} size={24} style={{marginRight:20}} color="blue" /> 
                        <Entypo name="share" onPress={() => share_func(type,v)} size={24} style={{marginRight:20}} color="blue" />
                    </View>
            );
        }

        ...
        const render_right = props => {
            return (
                    <View style={styles.row}>
                        <Fw5icon.Button backgroundColor="white" name="play" onPress={()=>open_func(type,v,nav)} size={24} style={{marginRight:24, backgroundColor:"white"}} color="red" /> 
                        <Entypo.Button backgroundColor="white" name="share" onPress={() => share_func(type,v)} size={24} style={{marginRight:20, backgroundColor:"white"}} color="blue" />
                    </View>
            );
        }

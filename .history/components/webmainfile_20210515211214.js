...
export default function Webb({navigation}){
    ...
    <View style={styles.container}>
        <View style={{alignSelf: 'stretch',backgroundColor:"beige"}}>
            <Icon.Button
            size={27}
            ...
            onPress={() => { webref.current.goForward() }}
             backgroundColor="beige" style={{position:"absolute", left:0, top:10}}/>
             <Icon.Button
            size={27} name="arrow-forward" color="black"
            onPress={() => { webref.current.goForward() }}
             backgroundColor="beige" style={{position:"relative", left:30}} />
        </View>
        <Webview
            ref={webref}

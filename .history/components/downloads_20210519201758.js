...
function Downloads({navigation}){
    return (
        <Tab.Navigator>
            <Tab.Screen  name="videos" options={{title:"ytd-964 Videos"}} component={VideoDownloads} />
            <Tab.Screen name="audios" options={{title:"ytd-964 Audios"}} component={AudioDownloads} />
        </Tab.Navigator>
    );
}

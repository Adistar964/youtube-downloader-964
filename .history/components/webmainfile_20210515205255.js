...
export default function Webb({navigation}){
    ...
    <View style={styles.container}>
        <View style={styles.row, {backgroundColor:"azure"}}>
            <Icon.Button
            onPress={() => {webref.current.goBack()}}
            name="back" backgroundColor="white" color="black" />
            <Icon.Button name="forward" color="black" backgroundColor="white" style={{marginLeft:}} />
        </View>
        <Webview
            ref={webref}

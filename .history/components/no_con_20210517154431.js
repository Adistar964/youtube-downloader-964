...
export default function Nocon({navigation}){
    ...
    return (
        <View style={styles.container}>
            <Title style={{marginTop:40, margin:20}}>Sorry! You are not connected to internet!</Title>
            <Button style={styles.dwnld} color="red" mode="contained" onPress={retry} >Retry</Button>
        </View>
    );
}
            ...
            return (
                    <View style={[styles.row, {backgroundColor:"white"}]}>
                        <View style={{marginRight:24}}>
                            <Fw5icon.Button backgroundColor="white" name="play" onPress={()=>open_func(type,v,nav)} size={24} color="red" />
                        </View> 
                        <View style={{marginRight:20}}>
                            <Entypo.Button backgroundColor="white" name="share" onPress={() => share_func(type,v)} size={24} color="blue" />
                        </View>
                    </View>
            );
        }

...
export default function Downloads({navigation}){
    ...
    const show_files = (v,i) => {
        if (v !== undefined && typeof v === "string"){
            ...
            const render_share = (props) => <List.Icon name="share-variant" onPress={call_share} {...props} /> ;
            ...
            return (
                <List.Item title={file_name} key={v} left={icon} right={(props) => <List.Icon name="share-variant" onPress={call_share} {...props} />} />
            )
        }
    }

...
import Player from "react-native-sound-playerview";
...
function StackNav () {
  ...
  React.useEffect(() => {
    ...
    const config_view = {title:"", headerStyle:{backgroundColor:"red"}}
    const config_dwnld = {title:"Downloads", headerStyle:{backgroundColor:"red"}}
    ...
    <NavigationContainer>
      <Stack.Navigator screenOptions={config_all}>
        ...
        <Stack.Screen component={noCon} options={config_home} name="noCon" />
        <Stack.Screen component={Downloads} options={config_dwnld} name="downloads" />
        ...
        <Stack.Screen component={Viewer} name="view" options={config_view} />
        <Stack.Screen component={Player} name="player" options={config_view} />
      </Stack.Navigator>
    </NavigationContainer>
    );
} 
